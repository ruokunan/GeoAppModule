package edu.washington.ruokua.geoappmodule;
...
//		CameraUpdate update = CameraUpdateFactory.newLatLng(LOCATION_BURNABY);
        ...
        CameraUpdate update = CameraUpdateFactory.newLatLngZoom(LOCATION_UW, 9);
        map.animateCamera(update);
    }
    public void onClick_Burnaby(View v) {
        map.setMapType(GoogleMap.MAP_TYPE_TERRAIN);
        CameraUpdate update = CameraUpdateFactory.newLatLngZoom(LOCATION_UW, 14);
        map.animateCamera(update);
